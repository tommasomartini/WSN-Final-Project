...
${OBJECTDIR}/_ext/1360937237/blacklist_message.o: ../src/blacklist_message.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/blacklist_message.o ../src/blacklist_message.cpp

${OBJECTDIR}/_ext/1360937237/event.o: ../src/event.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/event.o ../src/event.cpp

${OBJECTDIR}/_ext/1360937237/measure.o: ../src/measure.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/measure.o ../src/measure.cpp

${OBJECTDIR}/_ext/1360937237/message.o: ../src/message.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/message.o ../src/message.cpp

${OBJECTDIR}/_ext/1360937237/my_toolbox.o: ../src/my_toolbox.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/my_toolbox.o ../src/my_toolbox.cpp
...
${OBJECTDIR}/_ext/1360937237/project_2.o: ../src/project_2.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/project_2.o ../src/project_2.cpp

${OBJECTDIR}/_ext/1360937237/sensor_node.o: ../src/sensor_node.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/sensor_node.o ../src/sensor_node.cpp

${OBJECTDIR}/_ext/1360937237/storage_node.o: ../src/storage_node.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/storage_node.o ../src/storage_node.cpp

${OBJECTDIR}/_ext/1360937237/storage_node_message.o: ../src/storage_node_message.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/storage_node_message.o ../src/storage_node_message.cpp
